...
.EXAMPLE
    Find-TheMovieDBMovie -SearchString "Breaking Bad" -APIKey "your_api_key" -Year 2008 -ResultsCounts 1
...
Function Find-TheMovieDBMovie {
    ...
    $SearchParams = [string]::Join('&', "query=$EscapedString", "api_key=$APIKey")
    $SearchQuery = "$BaseURL/search/movie?$SearchParams"
    ...
    | Select-Object -First $ResultsCounts id, title, release_date, overview
